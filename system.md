...
#### Interaction with the cargotodebian variants feature
...
See:
 ...
 - A list of [shell fragments](https://github.com/mmstick cargotodebian/tree/579e10c89b060d=eec05ce8653f501c9eee3a0297/autoscripts) which may be inserted.
...
name = "example"
version = "1.2.3"
description = "An example package to demonstrate cargotodebian systemd-units support."
license = "MIT"
authors = [ cargotodebian team"]
...
Invoke cargotodebian with verbose output enabled:
...
#!/bin/sh
set -e
# Automatically added by cargotodebian
...
Note that two shell script fragments have been injected into the maintainer script and that the `#RESTART_ACTION#` and `#UNITFILE#` placeholder tokens have been replaced compared to the original autoscripts [here](https://github.com/mmstick cargotodebian/blob/master/autoscripts/postinst-systemd-dont-enable) and [here](https://github.com/mmstick cargotodebian/blob/master/autoscripts/postinst-systemd-restart).

#### Advanced Example

For a more advanced example you might want to look at the [NLnet Labs Krill project](https://github.com/NLnetLabs/krill/) use of cargotodebian (disclaimer: this author is a contributor) which shows:
...
- Use of operating system specific systemd service unit files via cargotodebian [variants](https://github.com/NLnetLabs/krill/blob/master/Cargo.toml#L111) and symbolic links (e.g. [here](https://github.com/NLnetLabs/krill/blob/master/debian/krill-debian10.krill.service)).
...
Additionally, though not strictly related to systemd-units support but still cargotodebian related, it shows:
